...
class EnemyTank extends Tank implements Runnable{
    ...
    public void run() {
		...
		switch(this.direction){
		  case 0:
			  for(int i=0;i<50;i++)
			  {   //这里存在一个问题：当有一辆敌人坦克碰到我的坦克时，所有敌人坦克都不能
				  //移动，这是在this.isTouchHero()中的问题，因为每一辆敌人坦克都是一个线程
				  //它一直都在执行run函数，所以每次都会调用isTouchHero()函数，而只要敌人坦克
				  //中有一辆坦克碰到我的坦克，就会返回false,这时所有的敌人坦克得到的值都为false
				  //所以它们都不会移动
